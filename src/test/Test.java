...
public class Test {
    public static void main(String[] args) throws FileNotFoundException, IOException {
        ...
        // System.out.println("identity test for head(): " + (table.equals(anotherTable)
        // ? "Fail" : "Pass"));

        // 6) 지정한 처음 n줄 출력 (새 테이블)
        // 892 라면?
        // table.head(30).print();
        // anotherTable = table.head(30);
        // System.out.println("identity test for head(n): " +
        // (table.equals(anotherTable) ? "Fail" : "Pass"));

        // 7) 마지막 5줄 출력 (새 테이블)
        // table.tail().print();
        // anotherTable = table.tail();
        // System.out.println("identity test for tail(): " + (table.equals(anotherTable)
        // ? "Fail" : "Pass"));

        // 8) 지정한 마지막 n줄 출력 (새 테이블)
        // table.tail(10).print();
        // anotherTable = table.tail(10);
        // System.out.println("identity test for tail(n): " +
        // (table.equals(anotherTable) ? "Fail" : "Pass"));

        // 9) 지정한 행 인덱스 범위(begin<=, <end)의 서브테이블을 얻는다. (새 테이블)
        // table.selectRows(0, 10).print();
        // anotherTable = table.selectRows(0, 10);
        // System.out.println("identity test for selectRows(range): " +
        // (table.equals(anotherTable) ? "Fail" : "Pass"));
        ...
        // System.out.println(
        // "identity test for selectColumnsAt(indices): " + (table.equals(anotherTable)
        // ? "Fail" : "Pass"));

        // // 11) 테이블을 기준 열인덱스(3)로 정렬한다. 이 때, 오름차순(true), null값은 나중에(false)(원본 테이블 정렬)
        // table.sort(5, true, true).print();
        // anotherTable = table.sort(5, false, false);
        // System.out.println(
        // "identity test for sort(index, assc, nullOrder): " +
        // (!table.equals(anotherTable) ? "Fail" : "Pass"));

        // 12) 테이블을 기s준 열인덱스(3)로 정렬한다. 이 때, 내림차순(false), null값은 앞에(true)(새 테이블)
        // CSVs.sort(table, 10, false, true).print();
        // anotherTable = CSVs.sort(table, 10, false, true);
        // System.out.println("identity test for CSVs.sort(index, asc, nullOrder): "
        // + (table.equals(anotherTable) ? "Fail" : "Pass"));

        // 13) 테이블을 랜덤하게 섞는다. (원본 테이블은 유지, 랜덤하게 섞인 새 테이블 반환)
        // System.out.println("*****s************************* before shuffling
        // ******************************");
        // table.print();
        ...
        // (original)******************************");
        // table.print();
        // System.out.println("identity test for CSVs.shuffle(table): " +
        // (table.equals(anotherTable) ? "Fail" : "Pass"));
        ...
        // (original)******************************");
        // table.print();
        // System.out.println("identity test for shuffle(): " +
        // (!table.equals(anotherTable) ? "Fail" : "Pass"));
        ...
        // nullCount += table.getColumn(i).getNullCount();
        // System.out.println("(before) null count: " + nullCount);
        // System.out.println("(result) table.fillNullWithMean(): " +
        // table.fillNullWithMean());
        // table.print();
        // nullCount = 0;
        // for (int i = 0; i < table.getColumnCount(); i++)
        // nullCount += table.getColumn(i).getNullCount();
        ...
        // nullCount += table.getColumn(i).getNullCount();
        // System.out.println("(before) null count: " + nullCount);
        // System.out.println("(result) table.fillNullWithZero(): " +
        // table.fillNullWithZero());
        // table.print();
        // nullCount = 0;
        // for (int i = 0; i < table.getColumnCount(); i++)
        // nullCount += table.getColumn(i).getNullCount();
        ...
        // System.out.println("The value in (" + rowIndex + ", " + columnIndex + ") is "
        // + value);
    }
}
